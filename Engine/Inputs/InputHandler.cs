...
public class InputHandler {
    ...
    private static Dictionary<Keys, string> keyboardBinds = new();
    ...
    public static void Update() {
        ...
        foreach (KeyValuePair<Keys, string> keybind in keyboardBinds) {
            if (Keyboard.GetState().IsKeyDown(keybind.Key)) {
    ...
    public static void addButtonBind(string name, Keys binding) {
    ...
    public static void addAnalogBind(string name, Keys binding) {
